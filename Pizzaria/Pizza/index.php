...
<?php
	...
	if(isset($_POST['email']) || isset($_POST['senha'])) {
		...
		if (strlen($_POST['email']) == 0) { //verifica se email é vazio
			$falhouLogin = true;
			$mensagemFalhaLogin = "Preencha seu email.";
		} else if (strlen($_POST['senha']) == 0) { //verifica se senha é vazio
			$falhouLogin = true;
			$mensagemFalhaLogin = "Preencha sua senha.";
		} else {
			...
			if($qntd == 1) {
				...
				$falhouLogin = true;
				$mensagemFalhaLogin = "Usuário não encontrado.";
			}
		}
	}
?>
	...
	<div class="container h-100">
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				?>
					<div class="mt-1">
						<div class="messagem_erro"><span><?php echo $mensagemFalhaLogin ?></span></div>
					</div>
				<?php
					}
				?>
